...
## The best data analysis is fast and intuitive

* The best data analysis starts with **fast** and intuitive Exploratory Data Analysis (EDA). You are in a [flow state absored](https://en.wikipedia.org/wiki/Flow_(psychology)) by the patterns and stories your data reveals. This includes any kind of data work from data engineering to [Kaggle Data Science competition winners](http://blog.kaggle.com/category/winners-interviews/).
...
* Each method starts with simple code so it you can use it as part of a fast Exploratory Data Analysis (EDA) toolkit. Then a more complex version is provided you can adapt to turn it into publicatoin quality plots.

* This is my *current* approach to data visualiation in R. But my methods keep changing from reading [R-Bloggers](https://www.r-bloggers.com/) and [#rstats](https://twitter.com/search?q=%23rstats&src=typd&lang=en) daily. 

* This diagram is from [R for Data Science](https://r4ds.had.co.nz/introduction.html#what-you-will-learn) that summarises the overall Data Science workflow. We're just going to look at the Visualise and Communicate parts underlined. And to emphasise the importance of clear well laid out code as also part of an internal communicationn to yourself and analysis colleagues.
...
* How David Robinson explores, cleans then analystes data in R inspires me. Several methods I use here I saw Robinson use on his Tidy Tuesday live coding YouTube videos. I'd strongly reccomend watching any of his live coding videos [here](https://www.youtube.com/results?search_query=david+robinson+tidy+tuesday). This book is a narrow section of Data Science of visualise and communicate, but you will see Robinson tackle the whole data sciecne path from import to communicate shown in the diagram above.
