...
* The only manipulation we will do to the txhousing data set is create a real date using [lubridate](https://lubridate.tidyverse.org/). We also create a smaller data frame with fewer American cities so some plots aren't too crowded.
