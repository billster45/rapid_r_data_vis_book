...
* Flexdashboards using [crosstalk] can be a good alternative to a [shinydashboard](https://rstudio.github.io/shinydashboard/) as the code is much easier to build and edit. This is because the interactivity for the user is taken care of by the simple crosstalk options. In contrast, with Shiny you will need to understand, build, and maintain the more complex [reactivity](https://shiny.rstudio.com/articles/reactivity-overview.html) of your app. As well as needing a platform to [deploy](https://shiny.rstudio.com/deploy/) your shiny app (html created by flexdashboard can be emailed to customers).
...
* When using R markdown I've found a [floating table of contents](https://bookdown.org/yihui/rmarkdown/html-document.html#table-of-contents) and [tabbed sections](https://bookdown.org/yihui/rmarkdown/html-document.html#tabbed-sections) are the most effective for providing compact and easy to navigate html documents. Particularly when you are presenting a lot information at once such as a detailed report.

## bookdown

* Finally, how this book itself was created is surprisingly quick to do. Here is a board [bookdown guide](https://bookdown.org/home/about/) to follow. This is how I built this book:
