...
* I've found animation, while fun to create and watch, should only be used where you can be sure the movement tells a story more effectively than a static plot. This is sometimes true for showing changes over time. Here is the monthly pattern of house sales we can see change each year. However, the static plot in the [Polish your final plot] section of this book probably gives the audience a better understanding of the change in sales over each year.
