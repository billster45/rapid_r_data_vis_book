...
* I've found animation is most effective at showing changes over time. Here is the annual pattern of house sales changing each year.
...
* The code is as simple as specifying which column to animate over as frames. The frames code line is commented on below.
