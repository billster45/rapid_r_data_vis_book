...
* Animation is easy to add. I've had a play here inspired by a good Tweet of examples you could follow:
https://github.com/billster45/gganimate-experiments/blob/master/README.md

* I've found animation is most effective when you see changes over time. Here is the annual pattern of sales changing each year.
