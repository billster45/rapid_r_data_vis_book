...
* However, Carson has already done some really nice bell and whislte plots on the Texas housing data already in his Plotly book: https://plotly-r.com/the-data-plot-pipeline.html


* And more here https://plotly-r.com/client-side-linking.html

* Below we re-produce Carson's plots with the identical code but it has been re-formatted applying the rules described earlier. This makes the examples easier to understand and re-use.
